...
export function Airplane({ variant = 'variant2', className = '' }: AirplaneProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="airplane-fuselageGrad" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id="airplane-tailGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#0f172a" />
          <stop offset="100%" stopColor="#334155" />
        </linearGradient>
        <linearGradient id="airplane-engineGrad" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#cbd5e1" />
          <stop offset="40%" stopColor="#64748b" />
          <stop offset="100%" stopColor="#1e293b" />
        </linearGradient>
        <linearGradient id="airplane-glassGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#38bdf8" stopOpacity="0.9" />
          <stop offset="100%" stopColor="#0284c7" stopOpacity="0.6" />
        </linearGradient>
        <linearGradient id="airplane-strutGrad" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <filter id="airplane-engineGlow" x="-50%" y="-50%" width="200%" height="200%">
      ...
      <path d="M60 78 L30 18 L100 18 L140 78 Z" fill="url(#airplane-tailGrad)" stroke="rgba(255,255,255,0.1)" strokeWidth="0.5" />
      ...
      <path
        d="M50 78 Q50 78 140 78 L440 78 C480 78 510 93 510 103 C510 113 480 128 440 128 L140 128 C90 128 50 113 50 103 Q50 93 50 78 Z"
        fill="url(#airplane-fuselageGrad)"
      ...
      <path d="M465 85 L490 88 L500 98 L498 103 L470 98 Z" fill="url(#airplane-glassGrad)" />
      ...
      <motion.g initial="down" animate={isGearDown ? 'down' : 'up'} variants={gearVariants}>
        <path d="M410 128 L435 128" stroke="#475569" strokeWidth="2" />
        <rect x="420" y="128" width="5" height="28" fill="url(#airplane-strutGrad)" rx="1" />
        <rect x="421" y="150" width="3" height="10" fill="#94a3b8" />
      ...
      <motion.g initial="down" animate={isGearDown ? 'down' : 'up'} variants={gearVariants}>
        <path d="M260 120 L260 155" stroke="url(#airplane-strutGrad)" strokeWidth="6" strokeLinecap="square" />
        ...
        <g transform="translate(260, 165)">
          ...
          <circle cx="5" cy="1" r="10" fill="#0f172a" />
      ...
      <g transform="translate(-5, 12)">
        ...
        <path d="M280 130 L260 135 L280 140 Z" fill="#38bdf8" filter="url(#airplane-engineGlow)" opacity="0.6">
          <animate attributeName="opacity" values="0.3;0.8;0.3" dur="2s" repeatCount="indefinite" />
        </path>
        <path d="M285 120 H355 C365 120 365 150 355 150 H285 C275 150 275 120 285 120 Z" fill="url(#airplane-engineGrad)" />
      ...
      <circle cx="280" cy="78" r="2" fill="#ef4444" filter="url(#airplane-glow)">
        <animate attributeName="opacity" values="0.2;1;0.2" dur="1.5s" repeatCount="indefinite" />
      </circle>
      <circle cx="140" cy="78" r="1.5" fill="#fff" filter="url(#airplane-glow)">
        <animate attributeName="opacity" values="0;1;0;0" dur="1.2s" repeatCount="indefinite" />
      </circle>
      <circle cx="185" cy="153" r="2" fill="#22c55e" filter="url(#airplane-glow)" opacity="0.9">
